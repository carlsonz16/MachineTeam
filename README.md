...
- Developed the backend to frontend logic for most React components, as well as many other solutions the site needed for images, charts, pagination, graphs, etc.
