...
def getFirstHalfPlayByPlays(game_id, home_team_tricode):
    try:
        ...
        filtered_actions = [
           {
              **{key: action.get(key, 'None') if key in ['actionType', 'subType', 'descriptor', 'area'] else action.get(key, None) for key in ['actionType', 'subType', 'descriptor', 'area', 'scoreHome', 'scoreAway']},
...
def get_pbp_data():
    ...
    output_folder = r'C:\Users\jdbas\Documents\code\precise-picks\excelPBPDataUnpaddedSecondsFormat'
